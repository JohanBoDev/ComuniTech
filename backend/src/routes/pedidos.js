...
const { obtenerPedidos, eliminarPedidoAdmin, obtenerDetallesPedido, actualizarEstadoPedido, obtenerTodosLosPedidos,obtenerDetallesPedidoAdmin, filtrarPedidos, eliminarPedido } = require('../controllers/pedidosController');
...
router.delete("/eliminarPedidoAdmin/:pedido_id", verificarToken, verificarRol([1]), eliminarPedidoAdmin);

...
const CategoriaMotherboards = () => {
  const { products: motherboards, loading, error } = useFetchProductsByCategory("motherboard");
  ...
  const filteredMotherboards = motherboards.filter((product) => {
    ...
    <div className="py-12 bg-cover bg-center bg-gradient-to-b from-gray-50 via-gray-100 to-gray-200 dark:from-black dark:via-black/90 dark:to-black">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-8 p-10">
        {filteredMotherboards.length > 0 ? (
          filteredMotherboards.map((product) => (
            <div
...
export default CategoriaMotherboards;

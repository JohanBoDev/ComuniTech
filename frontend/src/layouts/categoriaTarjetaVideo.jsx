...
const CategoriaTarjetaVideo = () => {
  const { products: tarjetas, loading, error } = useFetchProductsByCategory("tarjetas de video");
  ...
  const filteredTarjetas = tarjetas.filter((product) => {
...
export default CategoriaTarjetaVideo;

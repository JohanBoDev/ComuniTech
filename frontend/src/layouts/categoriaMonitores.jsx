...
const CategoriaMonitores = () => {
  const { products: monitores, loading, error } = useFetchProductsByCategory("monitor");
  ...
  const filteredMonitores = monitores.filter((product) => {

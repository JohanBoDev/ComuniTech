...
const CategoriaMouses = () => {
  const { products: mouses, loading, error } = useFetchProductsByCategory("mouse");
  ...
  const filteredMouses = mouses.filter((product) => {
...
export default CategoriaMouses;

...
const CategoriaProcesadores = () => {
  ...
  const [priceRange, setPriceRange] = useState([200000, 20000000]);
  const [searchTerm, setSearchTerm] = useState("");

  const filteredProcesadores = procesadores.filter((product) => {
...
export default CategoriaProcesadores;

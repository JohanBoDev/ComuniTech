            ...
            >
              {filteredUsuarios.map((usuario, index) => (
                <motion.div
                  ...
                  className={`flex flex-col lg:flex-row items-center p-4 ${index % 2 === 0
                    ? "bg-gray-100 dark:bg-[#1E1E1E]"
                    : "bg-white dark:bg-[#2A2A2A]"} border-b border-gray-300 dark:border-gray-600`}
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col lg:flex-row lg:items-center lg:justify-between w-full">
                    ...
                    <div className="lg:w-1/3 text-center lg:text-left">
                      <p
                        className={`font-medium ${usuario.es_admin === 1
